  ...
  return (
    <Card className={cn(
      ...
      <CardContent className="flex flex-col items-center gap-2">
        ...
        <Button className="mt-4 w-[200px] bg-[#009b51] text-lg  text-[var(--dashboard-topup-button-foreground)] rounded-full  hover:bg-[var(--dashboard-topup-button-bg)]/90">
          Top Up
        </Button>
      </CardContent>
    </Card>
  ...
  return (
    <Card className="p-4 bg-dashboard-card text-dashboard-card-foreground rounded-xl shadow-md">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Button variant="outline" className="text-[var(--dashboard-manage-button-foreground)] bg-[var(--dashboard-manage-button-bg)] rounded-full px-4 py-2 hover:bg-[var(--dashboard-manage-button-bg)]/90">
